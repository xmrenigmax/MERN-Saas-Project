...
const Navbar = ({ user, isSidebarOpen, setIsSidebarOpen }) => {
  ...
  <AppBar sx={{ position: "static", background: "none", boxShadow: "none", }} >
    <Toolbar sx={{ justifyContent: "space-between", width: "100%" }}>
      {/* LEFT SIDE */}
      <FlexBetween justify="flex-start" gap="2rem">
        <IconButton onClick={() => setIsSidebarOpen(!isSidebarOpen)}>
          <MenuIcon />
        </IconButton>
        <FlexBetween backgroundColor={theme.palette.background.alt} borderRadius="9px" gap="3rem" p="0.1rem 1.5rem" justify="flex-start" >
        ...
        {/* RIGHT SIDE */}
      <FlexBetween gap="1.5rem" justify="flex-end">
        ...
        <FlexBetween justify="flex-start">
