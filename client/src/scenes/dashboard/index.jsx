...
const Dashboard = () => {
  ...
  // Return the Dashboard component with various stats and chartss
  return (
    <Box m="1.5rem 2.5rem">
      <FlexBetween>
      ...
      <Box mt="20px" display="grid" gridTemplateColumns="repeat(12, 1fr)" gridAutoRows="160px" gap="20px" sx={{ "& > div": { gridColumn: isNonMediumScreens ? undefined : "span 12" },}} >
        ...
        <StatBox
          title="Yearly Sales" value={data && data.yearlySalesTotal} increase="+43%" description="Since last month"
